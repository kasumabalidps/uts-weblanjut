    ...
    <div class="bg-gray-800 p-8 rounded-lg shadow-2xl w-full max-w-md">
        ...
        <form action="<?=BASEURL; ?>/pengisian/daftar" method="POST" class="space-y-4">
            <div>
                ...
                <input type="text" id="nama" name="nama" required class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-lg py-2 px-3" oninput="this.value = this.value.replace(/</g, '&lt;').replace(/>/g, '&gt;')">
            </div>
            <div>
                <label for="nomer" class="block text-sm font-medium text-gray-300">Nomor HP</label>
                <input type="tel" id="nomer" name="nomer" required class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-lg py-2 px-3" oninput="this.value = this.value.replace(/</g, '&lt;').replace(/>/g, '&gt;')">
            </div>
            <div>
                <label for="karakter" class="block text-sm font-medium text-gray-300">Karakter Cosplay</label>
                <input type="text" id="karakter" name="karakter" required class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-lg py-2 px-3" oninput="this.value = this.value.replace(/</g, '&lt;').replace(/>/g, '&gt;')">
            </div>
            <div>
                <label for="anime" class="block text-sm font-medium text-gray-300">Asal Anime/Game</label>
                <input type="text" id="anime" name="anime" required class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-lg py-2 px-3" oninput="this.value = this.value.replace(/</g, '&lt;').replace(/>/g, '&gt;')">
            </div>
            <div>
            ...
            <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3" class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-lg py-2 px-3" oninput="this.value = this.value.replace(/</g, '&lt;').replace(/>/g, '&gt;')"></textarea>
            </div>
            <div>
