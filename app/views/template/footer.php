                ...
                <div class="container mx-auto px-4">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div class="text-center md:text-left">
                            ...
                            <p class="text-gray-400 mt-2">Kami berkomitmen memberikan layanan terbaik untuk para pecinta musik.</p>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <ul class="text-gray-400 space-y-2">
                                <li>Pemesanan Tiket Online</li>
                                <li>Membership VIP</li>
                        ...
                        <div class="text-center md:text-right">
                            ...
                            <div class="mt-4">
                                <h4 class="text-lg font-semibold mb-2">Download Aplikasi (Android & iOS)</h4>
                                <div class="flex justify-center md:justify-end space-x-2">
                                    <a href="#" class="text-gray-400 hover:text-white">
                                        <i class="fab fa-google-play text-2xl"></i>
                                    </a>
                                    <a href="#" class="text-gray-400 hover:text-white">
                                        <i class="fab fa-app-store-ios text-2xl"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
